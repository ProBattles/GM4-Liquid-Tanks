...
#adding 
	#bottle
	execute as @e[tag=gm4LTexperience,scores={gm4LiquidTanks=0..30000}] at @s if block ~ ~ ~ minecraft:hopper{Items:[{Slot:0b,id:"minecraft:experience_bottle",Count:1b}]} run tag @s add gm4LTbottleadd
	...
	#item
	execute as @e[tag=gm4LTexperience,scores={gm4LiquidTanks=0..30000}] at @s if block ~ ~ ~ minecraft:hopper{Items:[{Slot:0b,id:"minecraft:enchanted_book",Count:1b}]} run tag @s add gm4LTitemadd
...
#removing
	#bottle
	execute as @e[tag=gm4LTexperience,scores={gm4LiquidTanks=250..30000}] at @s if block ~ ~ ~ minecraft:hopper{Items:[{Slot:4b,id:"minecraft:glass_bottle",Count:1b}]} run tag @s add gm4LTbottleremove 
	execute as @e[tag=gm4LTexperience,tag=gm4LTbottleremove] run scoreboard players remove @s gm4LiquidTanks 250
	execute at @e[tag=gm4LTexperience,tag=gm4LTbottleremove] run replaceitem block ~ ~ ~ container.4 minecraft:experience_bottle 1
