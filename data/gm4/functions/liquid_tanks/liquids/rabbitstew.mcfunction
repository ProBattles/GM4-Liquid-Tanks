...
#adding 
	#bowl
	execute as @e[tag=gm4LTrabbitstew,tag=gm4LTslot,scores={gm4LiquidTanks=0..30000}] at @s if block ~ ~ ~ minecraft:hopper{Items:[{Slot:0b,id:"minecraft:rabbit_stew",Count:1b}]} run tag @s add gm4LTbowladd
	...
	execute as @e[tag=gm4LTrabbitstew,tag=gm4LTbowladd] run tag @s remove gm4LTslot
	execute as @e[tag=gm4LTrabbitstew,tag=gm4LTbowladd] run tag @s remove gm4LTbowladd


#removing
	#bowl
	execute as @e[tag=gm4LTrabbitstew,tag=gm4LTslot,scores={gm4LiquidTanks=250..30000}] at @s if block ~ ~ ~ minecraft:hopper{Items:[{Slot:0b,id:"minecraft:bowl",Count:1b}]} run tag @s add gm4LTbowlremove 
	execute as @e[tag=gm4LTrabbitstew,tag=gm4LTbowlremove] run scoreboard players remove @s gm4LiquidTanks 250
	execute at @e[tag=gm4LTrabbitstew,tag=gm4LTbowlremove] run replaceitem block ~ ~ ~ container.0 minecraft:rabbit_stew 1
	...
	execute as @e[tag=gm4LTrabbitstew,tag=gm4LTbowlremove] run tag @s remove gm4LTslot
